...
pub fn extract_gaussians<R: PlanarSync>(
        ...
        gaussians_query.iter()
    {
        ...
        let settings_uniform = CloudUniform {
            ...
            breathing_amplitude: settings.breathing_amplitude,
            breathing_speed: settings.breathing_speed,
            wave_amplitude: settings.wave_amplitude,
            wave_speed: settings.wave_speed,
            wave_frequency: settings.wave_frequency,
            jitter_amplitude: settings.jitter_amplitude,
            jitter_speed: settings.jitter_speed,
            sparkle_amplitude: settings.sparkle_amplitude,
            sparkle_speed: settings.sparkle_speed,
            pulse_amplitude: settings.pulse_amplitude,
            pulse_speed: settings.pulse_speed,
            pulse_frequency: settings.pulse_frequency,
            billboard: settings.billboard as u32,
            subsample: settings.subsample.max(1),
